...
public sealed class NonBinarySpaceTests
{
	...
	{
		PInvokeAssert.IsType<InvalidOperationException>(PInvokeAssert
		...
		PInvokeAssert.IsType<InvalidOperationException>(PInvokeAssert
		                                                .Throws<TypeInitializationException>(
			                                                BufferManager
				                                                .Register<
					                                                NonBinarySpace<InternalStruct<Int32>, Object>>)
		                                                .InnerException);
		PInvokeAssert.IsType<InvalidOperationException>(PInvokeAssert.Throws<TypeInitializationException>(
			                                                BufferManager
	...
	[Fact]
	public void ByteTest() => NonBinarySpaceTests.Test<Byte>();
	[Fact]
	public void Int16Test() => NonBinarySpaceTests.Test<Int16>();
	[Fact]
	public void Int32Test() => NonBinarySpaceTests.Test<Int32>();
	[Fact]
	...
	private static void Do<T>(ScopedBuffer<WrapperStruct<WrapperStruct<WrapperStruct<T>>>> buffer)
	{
		...
		PInvokeAssert.Equal(100, buffer.Span.Length);
		...
		PInvokeAssert.False(buffer.BufferMetadata.IsBinary);
