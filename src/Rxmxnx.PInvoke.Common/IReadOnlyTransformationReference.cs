...
public interface IReadOnlyTransformationReference<TSource, TDestination> : IReferenceable<TDestination>, IReadOnlyTransformedMemory<IReadOnlyFixedContext<TDestination>>
