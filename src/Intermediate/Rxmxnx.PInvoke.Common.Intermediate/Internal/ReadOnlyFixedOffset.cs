...
/// </summary>
/// <remarks>
/// This class is used to work with fixed read-only memory blocks by providing an additional offset for precise memory management.
/// </remarks>
internal sealed class ReadOnlyFixedOffset : ReadOnlyFixedMemory, IEquatable<ReadOnlyFixedOffset>
{
    ...
    public ReadOnlyFixedOffset(ReadOnlyFixedMemory mem, Int32 offset) : base(mem)
    {
        this._offset = offset;
    }
