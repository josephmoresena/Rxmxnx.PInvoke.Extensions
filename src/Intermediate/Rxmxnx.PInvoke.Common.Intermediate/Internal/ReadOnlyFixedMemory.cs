...
/// </summary>
internal unsafe abstract class ReadOnlyFixedMemory : FixedPointer, IReadOnlyFixedMemory, IEquatable<ReadOnlyFixedMemory>
{
    /// <summary>
    ...
    protected ReadOnlyFixedMemory(void* ptr, Int32 binaryLength, Boolean isReadOnly)
    ...
    /// <inheritdoc/>
    public virtual IReadOnlyFixedContext<Byte> AsBinaryContext() => new ReadOnlyFixedContext<Byte>(this.BinaryOffset, this);
}
