...
public readonly unsafe ref struct ReadOnlyFixedContextValue<T>
	...
	: IReadOnlyFixedContext<T>, IFixedPointerOperators<ReadOnlyFixedContextValue<T>>
#endif
{
#pragma warning disable CS8500
	...
	IReadOnlyFixedContext<Byte> IReadOnlyFixedMemory.AsBinaryContext()
	{
		...
		return new ReadOnlyFixedContext<Byte>(this._value.Pointer.ToPointer(), this._value.Size, isValid);
	}
#if !PACKAGE
	[ExcludeFromCodeCoverage]
#endif
	IReadOnlyFixedContext<Object> IReadOnlyFixedMemory.AsObjectContext()
	{
		...
		return new ReadOnlyFixedContext<Object>(this._value.Pointer.ToPointer(), count, isValid);
	}
#if !PACKAGE
	[ExcludeFromCodeCoverage]
#endif
		...
		out IReadOnlyFixedMemory residual)
	{
		...
		return new ReadOnlyFixedContext<TDestination>(this._value.Pointer.ToPointer(), count, isValid);
	}
#endif
