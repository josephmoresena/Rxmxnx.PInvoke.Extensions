...
public static partial class NativeUtilities
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe void WithSafeReadOnlyFixed<T, TArg>(ref T value, TArg arg, ReadOnlyFixedReferenceAction<T, TArg> action)
        where T : unmanaged
    {
        ArgumentNullException.ThrowIfNull(action);
        fixed (void* ptr = &value)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe TResult WithSafeReadOnlyFixed<T, TResult>(ref T value, ReadOnlyFixedReferenceFunc<T, TResult> func)
        where T : unmanaged
    {
    ...
    /// <returns>The result of <paramref name="func"/> execution.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static unsafe TResult WithSafeReadOnlyFixed<T, TArg, TResult>(ref T value, TArg arg, ReadOnlyFixedReferenceFunc<T, TArg, TResult> func)
        where T : unmanaged
    {
        ArgumentNullException.ThrowIfNull(func);
        fixed (void* ptr = &value)
