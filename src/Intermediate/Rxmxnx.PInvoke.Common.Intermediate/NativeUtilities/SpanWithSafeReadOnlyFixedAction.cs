...
public static unsafe partial class NativeUtilities
{
	...
	public static void WithSafeReadOnlyFixed<T0, T1>(Span<T0> span0, Span<T1> span1,
	...
	/// <param name="arg">A state object of type <typeparamref name="TArg"/>.</param>
	/// <param name="action">A <see cref="ReadOnlyFixedListAction{TArg}"/> delegate.</param>
	public static void WithSafeReadOnlyFixed<T0, T1, T2, TArg>(Span<T0> span0, Span<T1> span1, Span<T2> span2,
	...
	/// <param name="arg">A state object of type <typeparamref name="TArg"/>.</param>
	/// <param name="action">A <see cref="ReadOnlyFixedListAction{TArg}"/> delegate.</param>
	public static void WithSafeReadOnlyFixed<T0, T1, T2, T3, TArg>(Span<T0> span0, Span<T1> span1,
	...
	/// <param name="arg">A state object of type <typeparamref name="TArg"/>.</param>
	/// <param name="action">A <see cref="ReadOnlyFixedListAction{TArg}"/> delegate.</param>
	public static void WithSafeReadOnlyFixed<T0, T1, T2, T3, T4, TArg>(Span<T0> span0, Span<T1> span1,
	...
	/// <param name="action">A <see cref="ReadOnlyFixedListAction"/> delegate.</param>
	public static void WithSafeReadOnlyFixed<T0, T1, T2, T3, T4, T5>(Span<T0> span0, Span<T1> span1,
	...
	/// <param name="action">A <see cref="ReadOnlyFixedListAction"/> delegate.</param>
	public static void WithSafeReadOnlyFixed<T0, T1, T2, T3, T4, T5, T6>(Span<T0> span0, Span<T1> span1,
	...
	/// <param name="arg">A state object of type <typeparamref name="TArg"/>.</param>
	/// <param name="action">A <see cref="ReadOnlyFixedListAction{TArg}"/> delegate.</param>
	public static void WithSafeReadOnlyFixed<T0, T1, T2, T3, T4, T5, T6, T7, TArg>(Span<T0> span0,
