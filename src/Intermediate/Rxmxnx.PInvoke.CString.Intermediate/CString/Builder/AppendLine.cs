...
public partial class CString
{
	public sealed partial class Builder
	{
		...
		/// <summary>
		/// Appends the UTF-8 representation of the characters in a specified array followed by the default line
		...
		/// <summary>
		/// Appends the UTF-8 text followed by the default line terminator to the end of
		/// the current instance.
		/// </summary>
		...
		/// <summary>
		/// Appends the UTF-8 units array followed by the default line terminator to the end of
		/// the current instance.
		/// </summary>
		...
		/// <summary>
		/// Appends the UTF-8 representation of a specified character span followed by the default line terminator to the end of
		/// the current instance.
		/// </summary>
		/// <param name="value">The string to append.</param>
		/// <returns>A reference to this instance after the append operation has completed.</returns>
