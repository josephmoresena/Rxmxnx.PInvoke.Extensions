		...
		private sealed partial class Chunk
		{
			...
			private readonly ref struct CharSpanUtf8Split
			{
				...
				public CharSpanUtf8Split(ReadOnlySpan<Char> chars, Int32 charsByteCount, Int32 maxLeftByteCount)
				{
					...
					{
						Int32 runeUtf8Bytes =
							CharSpanUtf8Split.DecodeRune(chars[leftCharCount..], out Int32 charsConsumed);
				...
				private static Int32 GetInitialCharCount(Int64 charsLength, Int32 charsByteCount,
					Int32 maxLeftByteCount)
				{
