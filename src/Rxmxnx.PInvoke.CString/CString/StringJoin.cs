...
public partial class CString
{
    ...
    /// </returns>
    public static CString Join(Char separator, params String?[] value)
        => Join(CString.CreateSeparator(separator), value);
    ...
    public static CString Join(Char separator, IEnumerable<String?> values)
        => Join(CString.CreateSeparator(separator), values);
    ...
    public static CString Join(Char separator, String?[] value, Int32 startIndex, Int32 count)
        => Join(CString.CreateSeparator(separator), value, startIndex, count);
    ...
    /// <paramref name="value"/> has zero elements.
    /// </returns>
    public static CString Join(String? separator, params String?[] value)
    {
    ...
    /// <summary>
    /// Concatenates the specified elements of a UTF-16 texts array, using the specified
